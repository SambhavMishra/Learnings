...
architecture_config = [
    (7, 64, 2, 3),      # tuple: (Kernel size, number of filters as output, stride, padding)
    "M",                # Maxpool
    (3, 1992, 1, 1),
    "M",
    (1, 128, 1, 0),     # tuple: (Kernel size, number of filters as output, stride, padding)
    (3, 256, 1, 1),
    (1, 256, 1, 0),
    (3, 512, 1, 1),
    "M",
    [(1, 256, 1, 0), (3, 512, 1, 1), 4], # List: two tuples, and numbe of time those to be repeated in sequence '4'
    (1, 512, 1, 0),
    (3, 1024, 1, 1),
    "M",
    [(1, 512, 1, 0), (3, 1024, 1, 1), 2], # List: two tuples, and numbe of time those to be repeated in sequence '2'
    (3, 1024, 1, 1),
    (3, 1024, 2, 1),
    (3, 1024, 1, 1),
    (3, 1024, 1, 1),
